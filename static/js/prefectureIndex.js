...
$(function () {
    ...
    for (var i = 0; i < prefLength; i++) {
        ...
        if (value == '都道府県を選択してください') {
            ...
            // prefOption += '<label class="custom-check"><input type="checkbox" value="' + value + '" name="pref"/><span class="check-btn"><i class="las la-check"></i><div class="hobbies-icon-check"><h3>' + value + '</h3></div></span></label>'
        } else {
            // prefOption += '<input class="pref_class" name="pref" type="checkbox" value="' + value + '">' + value + '\n';
            prefOption += '<label class="custom-check"><input class="pref_class" type="radio" value="' + value + '" name="pref"/><span class="check-btn"><i class="las la-check"></i><div class="hobbies-icon-check"><h3>' + value + '</h3></div></span></label>'
            // console.log(value)
        }
        $('#pref_area').html(prefOption);
    }

    $('.pref_class').on('change', function () {
        var cityOption = '';
        var index = $(this).prop('selectedIndex');
        var selected = $(this).val();
        console.log(selected)

        for (var i = 1; i < prefLength; i++){
            citydata = pref[i][0]
            if (selected == citydata){
                pref[i][1][0] += 1;
                for(var j = 2; j < pref[i][1].length; j++){
                    cityOption += '<label class="custom-check"><input type="checkbox" value="' + pref[i][1][j] + '" name="city"/><span class="check-btn"><i class="las la-check"></i><div class="hobbies-icon-check"><h3>' + pref[i][1][j] + '</h3></div></span></label>'
                }
            }
            if (pref[i][1][0] % 2 == 1){
                cityDiv = '<div class="' + selected + '">' + cityOption + '</div>'
                $('#city_area').html(cityDiv).fadeIn();
            }
        }
        ...
        //             // cityOption += '<label class="custom-check"><input type="checkbox" value="' + this + '" name="city"/><span class="check-btn"><i class="las la-check"></i><div class="hobbies-icon-check"><h3>' + this + '</h3></div></span></label>'
        //             // console.log(this);
        //         } else {
        ...
        //         }
        //     });
        //     $('#city_area').html(cityOption).fadeIn();
        // } else {
        //     $('#city_area').hide();
        // }
    });
